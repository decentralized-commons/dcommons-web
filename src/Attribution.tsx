    ...
    return <main>
        ...
        <div>
            ...
            <p><a href="https://wiki.creativecommons.org/wiki/Best_practices_for_attribution">
                Best practices for attribution</a> from Creative Commons guidelines licensed under <a
        ...
        <div>
            ...
            <p><a
                ...
                href="https://www.decentralizedcommons.org/by/0.1/">DC BY 0.1</a></p>
            <p>
                Because:
            </p>
            <ul>
        ...
        <div>
            ...
            <p>
                ...
                href="https://www.decentralizedcommons.org/by/0.1/">DC BY 0.1</a>
            </p>
            <p>
                Because:
            </p>
        ...
        <div>
            ...
            <p>
                <a
                    href="http://timothyvollmer.com/8256206923">“Creative
                    Commons 10th Birthday Celebration San Francisco”</a> created by <a
                href="http://timothyvollmer.com">tvol</a> and <a href="http://tvol-3348431.dcr/8256206923">registered
                with DC registry</a> is licensed under <a
                href="https://www.decentralizedcommons.org/by/0.1/">DC BY 0.1</a>
            </p>
            <p>
                Dynamic attribution requires updates to the linked URIs to mirror updates done by the creator with the
                registry. Convenient automatic updates of attribution are only possible for websites that use
                JavaScript. Every time user visits the page, JS script loads the attribution data directly from the
                registry.
            </p>
            <p>
                Because:
            ...
            <p>
                <ul>
                    ...
                    <li>
                        Source? “Creative Commons 10th Birthday Celebration San Francisco” - linked to <HD>the image
                        URI on creator's domain and image URI on the registry</HD>
                    </li>
                    <li>
                        License? “DC BY 0.1” - linked to license deed
                    </li>
            ...
            attribute.
            <ul>
                <li>Author -> <HD>to author's domain</HD></li>
                <li>Source -> <HD>to registry domain -> to author's domain</HD></li>
                <li>Source -> <HD>to author's domain</HD></li>
                main
                <li>License -> to decentralized commons website</li>
            </ul>
            <p>
